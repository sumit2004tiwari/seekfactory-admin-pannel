import type { ChatMessageType, CommentType, EmailType, GroupType, SocialUserType, TeamMemberType } from '@/types/data'
...
export const socialUsersData: SocialUserType[] = [
  {
    id: '101',
    avatar: avatar1,
...
const defaultTo: SocialUserType = {
  id: '112',
  mutualCount: 56,
...
for (const user of socialUsersData) {
  messages.push(
    ...
    },
    {
      ...
      message: {
        type: 'text',
        value: "Hi Admin, thanks for joining the meeting. Let's dive into our quarterly performance review.",
      },
      sentOn: addOrSubtractMinutesFromDate(110),
    },
    {
